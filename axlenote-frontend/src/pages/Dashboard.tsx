        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                <div>
                    <h1 className="text-4xl font-black text-white tracking-tight mb-2">
                        My <span className="text-violet-500">Garage</span>
                    </h1>
                ...
                <div className="flex gap-4">
                    <div className="bg-zinc-900 border border-white/5 px-6 py-3 rounded-2xl shadow-xl shadow-black/20">
                        <p className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider mb-1">Total Fleet Cost</p>
            ...
            {fleetStats.totalCost > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-violet-500/20 transition-all duration-500">
                        ...
                        <p className="text-zinc-500 text-xs font-bold uppercase tracking-wider mb-2">Fuel Consumed</p>
                        <p className="text-4xl font-bold text-white tracking-tight">
                            <CountUp end={fleetStats.totalFuel} decimals={1} suffix="" /> <span className="text-lg text-zinc-600 font-medium">L</span>
                        </p>
                    </div>

                    <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-emerald-500/20 transition-all duration-500">
                        <div className="absolute top-0 right-0 p-4 opacity-20 group-hover:opacity-30 transition-opacity">
                        ...
                        <p className="text-zinc-500 text-xs font-bold uppercase tracking-wider mb-2">Service Records</p>
                        <p className="text-4xl font-bold text-white tracking-tight">
                            <CountUp end={fleetStats.totalServices} />
                        </p>
                    </div>

                    <div className="bg-zinc-900 border border-white/5 rounded-2xl p-6 flex flex-col justify-center items-center text-center relative overflow-hidden">
                        ...
                        <p className="relative z-10 text-zinc-400 text-sm font-medium mb-1">Active Vehicles</p>
                        <p className="relative z-10 text-5xl font-black text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading ? (
                    ...
                    <div className="col-span-full py-20 text-center bg-zinc-900/30 rounded-3xl border border-dashed border-zinc-800">
                        <p className="text-zinc-400 text-lg mb-4">Your garage is empty.</p>
                        <button onClick={() => setIsModalOpen(true)} className="text-violet-400 font-bold hover:text-violet-300 underline underline-offset-4 cursor-pointer">Add your first vehicle</button>
                    </div>
                ) : (
                    <>
                        {vehicles.map(v => (
                        ...
                        <button
                            ...
                            className="group relative h-full min-h-[280px] rounded-3xl border-2 border-dashed border-zinc-800 hover:border-violet-500/30 hover:bg-zinc-900/30 transition-all duration-300 flex flex-col items-center justify-center gap-4 cursor-pointer"
                        >
                            <div className="w-16 h-16 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center group-hover:scale-110 group-hover:border-violet-500/50 group-hover:shadow-lg group-hover:shadow-violet-500/20 transition-all duration-300">
                                <svg className="w-8 h-8 text-zinc-600 group-hover:text-violet-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                                </svg>
                            </div>
                            <span className="font-bold text-zinc-500 group-hover:text-white transition-colors">Add Vehicle</span>
                        </button>
                    </>
                )}
            </div>
